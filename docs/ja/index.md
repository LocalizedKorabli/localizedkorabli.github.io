...
hero:
  ...
  tagline: "<p>コミュニティ主導の『Мир кораблей』</p><p>有志ローカライズチーム</p>"
  actions:
    - theme: brand
      text: ダウンロード
      link: /ja/lk-next
...
features:
  ...
  - title: 多言語対応
    details: 日本語、簡体字中国語、繁体字中国語、英語をサポート。地域を問わず、全てのプレイヤーが快適にゲームを楽しめる環境を目指しています
  - title: LGC・МОСТ ローカライズ
    details: 新登場の澪刻 Lateral インストーラーは LGC・МОСТ ローカライズ専用。ワンクリックでゲームにさらなるローカライズコンテンツを追加できます
---
