...
<div class="vp-doc custom-about-page">
  ...
  <header class="about-header">
    <h1 class="main-title">關於澪刻</h1>
    <p class="tagline">瞭解此專案的前世今生與背後的團隊</p>
    <div class="action-buttons">
      <a class="vp-button brand" href="https://github.com/LocalizedKorabli">前往團隊頁</a>
      <a class="vp-button alt" href="https://discord.gg/3d9k2mkWy4">加入 Discord</a>
    </div>
  </header>
    ...
    <div class="team-grid">
      ...
      <div class="team-card">
        ...
        <div class="info">
          ...
          <span class="role">開發者 / 翻譯者</span>
        </div>
      </div>
    </div>

<h3 class="group-title" style="margin-top: 48px;">貢獻者<sub>(A-Z)</sub></h3>
    <ContributorList />
</section>
    ...
    <div class="links-grid">
      ...
      <a href="https://lestatranslate.xyz/" target="_blank" class="link-card">
        <div class="link-content">
          ...
          <span class="link-desc">為 Мир танков 提供英、波、德、西、韓等多語言在地化的團隊</span>
        </div>
      </a>
      <a href="https://mktool.info/" target="_blank" class="link-card">
        <div class="link-content">
          <span class="link-name">MKtool</span>
          <span class="link-desc">為 Мир кораблей 艦艇提供數據分析的網站</span>
        </div>
      </a>
    </div>
  </section>
